...
import logo from '../../assets/svgs/kadet_footer.svg'
      ...
      <div className='base_container'>
        <div className="hero">
          ...
          <div className="description">
            <p> <span>I'm a <span className='highlight'>Frontend Developer</span>. I spend most of my time writing code for applications using </span> <span className='highlight'>Javascript</span><span> and it's libraries/frameworks. I use CSS and </span> <span className='highlight'>SASS </span> <span> to design efficient user interfaces. I love talking about tech and also write on my <a href="https://kadet.hashnode.dev" target='_blank' rel="noopener noreferrer">blog</a> ocassionally</span></p>
          </div>
