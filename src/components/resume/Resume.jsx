        ...
        <div className='resume_container'>
          <div className="top_row">
            ...
            <div className="buttons">
              ...
              <a href="https://drive.google.com/file/d/1TgCq88QVeaeCjLV70sGmzM_tGqPvzGWI/view?usp=sharing" target='_blank' rel="noopener noreferrer"><small><i className="fas fa-download"></i> <span>Download </span> </small></a> 
            </div>
          </div>
